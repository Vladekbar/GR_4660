...
7. Далее можно производить с содержимым папки все, что угодно. 
Изменения будут видны только вам, и происходить только на вашем ПК.
...
5. GitHub, как вещь практичная, сама предложит нам варианты, что делать нам дальше, исходя из планом.
